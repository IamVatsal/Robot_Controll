...
class EnhancedRobotFaceSystem:
    ...
    def draw_simple_text(self, text, x, y, alpha=1.0):
        ...
        try:
            ...
            # Draw textured quad (corrected texture coordinates to fix inversion)
            glBegin(GL_QUADS)
